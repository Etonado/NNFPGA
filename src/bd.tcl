...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins nn_inference_0/s_axi_AXI_CPU]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins nn_inference_0/ap_rst_n] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
